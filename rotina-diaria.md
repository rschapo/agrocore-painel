...
- NÃO altere o bloco <header>/logo; só atualize a data em "Atualizado em ...". Isso inclui o bloco `.agc-header-contact` (ícones de e-mail/WhatsApp/Instagram/LinkedIn ao lado do título), o `<a href="https://www.agrocore.com.br">` que envolve a logo do cabeçalho (adicionado em 22/07/2026 — a logo deve continuar linkando para o site institucional) e o `<footer class="agc-footer">` institucional no fim da página (logo, contato, redes, linha legal com CNPJ) — **nunca remova, esvazie ou reformate esses blocos** (adicionados em 14/07/2026 e 22/07/2026); eles não fazem parte do conteúdo de dados do dia.
